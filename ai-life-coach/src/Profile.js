...
import { Moon, Sun, User, Bot, Upload, Camera, Sparkles, Settings, User2, Brain, CreditCard, Coins, Trash2, X, ChevronUp, ChevronDown, Star, ArrowRight, Trophy, Target } from 'lucide-react';
              ...
              {activeSection === 'goals' && (
                <div className={`rounded-2xl backdrop-blur-sm border p-8 transition-all duration-500 ${
                  ...
                  <div className="mb-8">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <button
                        onClick={() => {
                          ...
                          const updated = [...goals.map(g => ({ ...g, isExpanded: false })), newGoal];
                          setGoals(updated);
                          setExpandedGoal(newGoal.id);
                          checkForGoalChanges(updated);
                        }}
                        className={`px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 ${
                          darkMode
                            ? 'bg-gradient-to-r from-blue-500/20 to-indigo-500/20 text-blue-300 hover:from-blue-500/30 hover:to-indigo-500/30 border border-blue-400/30'
                    ...
                    <div className="space-y-3">
                      {goals.map((goal) => (
                        <div key={goal.id} className={`rounded-xl border transition-all duration-300 ${
                          darkMode ? 'bg-white/5 border-white/20 hover:border-white/30' : 'bg-white/70 border-gray-200 hover:border-gray-300'
                        } ${expandedGoal === goal.id ? 'shadow-lg' : 'shadow-sm hover:shadow-md'}`}>
                              ...
                              <div className="pt-4 space-y-4">
                                <div className="flex items-center gap-3">
                                  <input
                                    ...
                                    className={`flex-1 p-3 rounded-xl border font-semibold transition-all duration-200 ${
                                      darkMode
                                        ? 'bg-white/10 border-white/20 text-white placeholder-white/50 focus:border-blue-400 focus:bg-white/15'
                                        : 'bg-white border-gray-200 text-gray-800 placeholder-gray-500 focus:border-blue-400 focus:ring-2 focus:ring-blue-100'
                                    } focus:outline-none`}
                                  />
                                  <button
                                    onClick={() => {
                                    ...
                                    className={`p-2 rounded-xl transition-all duration-200 ${
                                      darkMode
                                        ? 'text-red-400 hover:bg-red-400/20 hover:text-red-300'
                                ...
                                <textarea
                                  ...
                                  className={`w-full p-3 rounded-xl border resize-none transition-all duration-200 ${
                                    darkMode
                                      ? 'bg-white/5 border-white/20 text-white placeholder-white/50 focus:border-blue-400 focus:bg-white/10'
                                      : 'bg-white/70 border-gray-200 text-gray-800 placeholder-gray-500 focus:border-blue-400 focus:ring-2 focus:ring-blue-100'
                                  } focus:outline-none`}
                                  rows={3}
                                />
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                  <div>
                                    ...
                                    <div className="relative">
                                      <select
                                        ...
                                        className={`w-full p-3 rounded-xl border appearance-none transition-all duration-200 ${
                                          darkMode
                                            ? 'bg-white/10 border-white/20 text-white focus:border-blue-400 focus:bg-white/15'
                                            : 'bg-white border-gray-200 text-gray-800 focus:border-blue-400 focus:ring-2 focus:ring-blue-100'
                                        } focus:outline-none cursor-pointer`}
                                      >
                                        <option value="">Select category...</option>
                                        {lifeDomains.map(domain => (
                                          <option key={domain.id} value={domain.domain} className={darkMode ? 'bg-gray-800' : 'bg-white'}>
                                            {domain.domain}
                                          </option>
                                        ))}
                                        <option value="personal" className={darkMode ? 'bg-gray-800' : 'bg-white'}>Personal</option>
                                        <option value="professional" className={darkMode ? 'bg-gray-800' : 'bg-white'}>Professional</option>
                                        <option value="health" className={darkMode ? 'bg-gray-800' : 'bg-white'}>Health</option>
                                        <option value="relationships" className={darkMode ? 'bg-gray-800' : 'bg-white'}>Relationships</option>
                                        <option value="financial" className={darkMode ? 'bg-gray-800' : 'bg-white'}>Financial</option>
                                        <option value="learning" className={darkMode ? 'bg-gray-800' : 'bg-white'}>Learning</option>
                                      </select>
                                  ...
                                  <div>
                                    ...
                                    <div className="relative">
                                      ...
                                      >
                                        <option value="low" className={darkMode ? 'bg-gray-800' : 'bg-white'}>Low</option>
                                        <option value="medium" className={darkMode ? 'bg-gray-800' : 'bg-white'}>Medium</option>
                                        <option value="high" className={darkMode ? 'bg-gray-800' : 'bg-white'}>High</option>
                                        <option value="critical" className={darkMode ? 'bg-gray-800' : 'bg-white'}>Critical</option>
                                      </select>
                                      <ChevronDown className={`absolute right-3 top-1/2 transform -translate-y-1/2 w-4 h-4 pointer-events-none ${
                                        darkMode ? 'text-white/50' : 'text-gray-400'
                                      }`} />
                                  ...
                                  <div>
                                    ...
                                    <div className="relative">
                                      ...
                                      >
                                        <option value="not-started" className={darkMode ? 'bg-gray-800' : 'bg-white'}>Not Started</option>
                                        <option value="in-progress" className={darkMode ? 'bg-gray-800' : 'bg-white'}>In Progress</option>
                                        <option value="paused" className={darkMode ? 'bg-gray-800' : 'bg-white'}>Paused</option>
                                    ...
                                    <input
                                      ...
                                      className={`w-full p-3 rounded-xl border transition-all duration-200 ${
                                        darkMode
                                          ? 'bg-white/10 border-white/20 text-white focus:border-blue-400 focus:bg-white/15'
                                          : 'bg-white border-gray-200 text-gray-800 focus:border-blue-400 focus:ring-2 focus:ring-blue-100'
                                      } focus:outline-none [color-scheme:${darkMode ? 'dark' : 'light'}]`}
                                    />
                                  </div>
                                </div>
                                ...
                                <div>
                                  <div className="flex items-center justify-between mb-3">
                                    ...
                                    <span className={`text-sm font-semibold px-2 py-1 rounded-lg ${
                                      darkMode ? 'text-blue-300 bg-blue-500/20' : 'text-blue-600 bg-blue-100'
                                    }`}>
                                      {goal.progress}%
                                    </span>
                                  </div>
                                  <div className="space-y-2">
                                    <input
                                      ...
                                      className={`w-full h-2 rounded-lg appearance-none cursor-pointer transition-all duration-200 ${
                                        darkMode 
                                          ? 'bg-white/20 [&::-webkit-slider-thumb]:bg-blue-500 [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-blue-400' 
                                          : 'bg-gray-200 [&::-webkit-slider-thumb]:bg-blue-500 [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-blue-400'
                                      } [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-5 [&::-webkit-slider-thumb]:h-5 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:shadow-md hover:[&::-webkit-slider-thumb]:shadow-lg [&::-webkit-slider-thumb]:transition-all`}
                                      style={{
                                        background: `linear-gradient(to right, #3b82f6 0%, #6366f1 ${goal.progress}%, ${darkMode ? 'rgba(255,255,255,0.2)' : '#e5e7eb'} ${goal.progress}%, ${darkMode ? 'rgba(255,255,255,0.2)' : '#e5e7eb'} 100%)`
                                      }}
                                    />
                                  </div>
                                </div>
                      ...
                      {goals.length === 0 && (
                        <div className={`text-center py-12 ${
                          ...
                          <p className="text-lg font-medium mb-2">No goals added yet</p>
                          <p className="text-sm">Click "Add Goal" to create your first goal and start tracking your progress.</p>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  {hasUnsavedGoalChanges && (
                    <div className="flex justify-center pt-6 border-t border-white/20">
                      <button
                        onClick={handleApplyGoalChanges}
                        className={`px-8 py-3 rounded-xl font-semibold transition-all duration-200 ${
                          darkMode
                            ? 'bg-gradient-to-r from-blue-500 to-indigo-600 text-white hover:from-blue-600 hover:to-indigo-700'
                            : 'bg-gradient-to-r from-blue-500 to-indigo-600 text-white hover:from-blue-600 hover:to-indigo-700'
                        } shadow-lg hover:shadow-xl transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 ${
